...
| **Asignaciones y distribución** | Asignación actividad-empleado, Asignaciones base, Asignación de centros, Historial de asignaciones, Centros (distribución y costos finales) | `/api/asignacion-actividad-empleado`, `/api/asignaciones`, `/api/asignacion-centro`, `/api/asignaciones/historial/:centro`, `/api/centros-apoyo/distribucion`, `/api/costos-finales/:sku`【F:src/index.ts†L93-L114】【F:src/modules/asignacion/routes/asignacion.routes.ts†L15-L21】【F:src/modules/asignacion-historial/routes/asignacion-historial.routes.ts†L6-L8】【F:src/modules/centros/routes/costos-finales.routes.ts†L6-L8】 |
